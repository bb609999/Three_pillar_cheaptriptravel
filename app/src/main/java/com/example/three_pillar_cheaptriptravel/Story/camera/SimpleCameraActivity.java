...
public class SimpleCameraActivity extends AppCompatActivity implements
        ...
        switch (item.getItemId()) {
            case R.id.aspect_ratio:
                ...
                if (mCameraView != null
                    ...
                    final com.google.android.cameraview.AspectRatio currentRatio = mCameraView.getAspectRatio();
    ...
    @Override
    public void onAspectRatioSelected(@NonNull com.google.android.cameraview.AspectRatio ratio) {
        if (mCameraView != null) {
